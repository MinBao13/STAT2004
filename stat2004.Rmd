...
pred_obj <- predict(rf_model, newdata = test_data)
y_hat    <- as.numeric(pred_obj$predicted)
y_true   <- as.numeric(test_data$AQI)
...
#Add more stuff or explore different models, for example, AQI ~ only pollutants or AQI ~ temperature + other vars. 
